...
return [
    "Agility" => [
        'description' => "The Agility characteristic measures your character's manual dexterity, hand-eye coordination, and body control. Characters with a high Agility have flexibility, a good sense of balance, and deft hands. Agility is used for a number of physical skills, such as Coordination, and it is key in ranged combat.",
    ],
    "Brawn" => [
    ...
    "Willpower" => [
        'description' => "The Willpower characteristic reflects your character's discipline, self-control, mental fortitude, and faith. Characters with a high Willpower can withstand stress and fatigue, remain composed during chaotic situations, and exert influence over the weaker willed. Willpower is used for skills such as Coercion and Vigilance. Willpower is also used to determine your character's starting strain threshold.",
    ],
];